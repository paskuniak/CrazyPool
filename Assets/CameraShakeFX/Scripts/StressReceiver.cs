...
public class StressReceiver : MonoBehaviour 
{
    ...
    private const float SubtleIntensity = 0.2f;
    private const float NormalIntensity = 0.8f;
    private const float ExtremeIntensity = 3f;
    ...
    public void Shake(Intensity intensity)
    {
        ...
        switch (intensity)
        {
            case Intensity.Subtle:
                stress = SubtleIntensity;
                break;
            case Intensity.Normal:
                stress = NormalIntensity;
                break;
            case Intensity.Extreme:
                stress = ExtremeIntensity;
                break;
        }
